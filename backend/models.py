...
class Question(db.Model):
    ...
    option1 = db.Column(db.Boolean(), nullable=True)
    answer2 = db.Column(db.String(240), unique=True, nullable=False)
    option2 = db.Column(db.Boolean(), nullable=True)
    answer3 = db.Column(db.String(240), unique=True, nullable=False)
    option3 = db.Column(db.Boolean(), nullable=True)
